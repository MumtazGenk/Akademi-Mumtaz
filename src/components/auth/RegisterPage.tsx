        ...
        >
          <div className="backdrop-blur-2xl bg-white/90 rounded-[22px] p-6 sm:p-8 border border-white/80 relative overflow-hidden">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-xl border border-zinc-200 bg-white hover:bg-zinc-50 text-zinc-800 font-semibold text-xs transition-all shadow-xs flex items-center justify-between cursor-pointer disabled:opacity-50 mb-5 group"
            >
