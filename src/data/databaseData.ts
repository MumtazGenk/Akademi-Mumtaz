...
export const SQL_SCHEMA_OVERVIEW = [
  ...
  {
    table: 'presensi',
    description: 'Catatan presensi dan absensi kehadiran harian siswa per rombel dan tanggal',
    columns: [
      { name: 'id_presensi', type: 'int(11)', key: 'PRI', extra: 'AUTO_INCREMENT' },
      { name: 'nis', type: 'varchar(20)', key: 'MUL', extra: 'FK -> siswa(nis)' },
      { name: 'id_kelas', type: 'int(11)', key: 'MUL', extra: 'FK -> kelas(id_kelas)' },
      { name: 'tanggal', type: 'date', key: '', extra: 'NOT NULL' },
      { name: 'status', type: "enum('Hadir','Sakit','Izin','Alpa')", key: '', extra: 'NOT NULL' },
      { name: 'keterangan', type: 'text', key: '', extra: 'DEFAULT NULL' },
      { name: 'created_at', type: 'timestamp', key: '', extra: 'DEFAULT CURRENT_TIMESTAMP' },
    ],
    count: 20,
  },
  {
    table: 'remedial',
    description: 'Riwayat program perbaikan nilai siswa di bawah standar KKM 75.00',
    columns: [
      { name: 'id_remedial', type: 'int(11)', key: 'PRI', extra: 'AUTO_INCREMENT' },
      { name: 'id_nilai', type: 'int(11)', key: 'MUL', extra: 'FK -> nilai(id_nilai)' },
      { name: 'nis', type: 'varchar(20)', key: 'MUL', extra: 'FK -> siswa(nis)' },
      { name: 'id_mapel', type: 'int(11)', key: 'MUL', extra: 'FK -> mata_pelajaran(id_mapel)' },
      { name: 'id_tahun_ajaran', type: 'int(11)', key: 'MUL', extra: 'FK -> tahun_ajaran(id_tahun_ajaran)' },
      { name: 'nilai_awal', type: 'decimal(5,2)', key: '', extra: 'NOT NULL' },
      { name: 'nilai_remedial', type: 'decimal(5,2)', key: '', extra: 'NOT NULL' },
      { name: 'tanggal', type: 'date', key: '', extra: 'NOT NULL' },
      { name: 'catatan', type: 'text', key: '', extra: 'DEFAULT NULL' },
      { name: 'created_at', type: 'timestamp', key: '', extra: 'DEFAULT CURRENT_TIMESTAMP' },
    ],
    count: 5,
  },
  {
    table: 'user_profiles',
    description: 'Profil akun terdaftar untuk autentikasi dan otorisasi berbasis peran (RBAC)',
    columns: [
      { name: 'id', type: 'varchar(64)', key: 'PRI', extra: 'NOT NULL' },
      { name: 'email', type: 'varchar(100)', key: 'UNI', extra: 'NOT NULL' },
      { name: 'nama_lengkap', type: 'varchar(100)', key: '', extra: 'NOT NULL' },
      { name: 'role', type: "enum('admin','guru','siswa')", key: '', extra: 'NOT NULL' },
      { name: 'identifier', type: 'varchar(50)', key: '', extra: 'NOT NULL' },
      { name: 'created_at', type: 'timestamp', key: '', extra: 'DEFAULT CURRENT_TIMESTAMP' },
    ],
    count: 26,
  },
  {
    ...
    description: 'Jejak log audit keamanan aktivitas login, logout, lockout, dan mutasi data',
    columns: [
      { name: 'id', type: 'varchar(64)', key: 'PRI', extra: 'NOT NULL' },
      { name: 'timestamp', type: 'timestamp', key: '', extra: 'DEFAULT CURRENT_TIMESTAMP' },
      { name: 'action', type: 'varchar(30)', key: '', extra: 'NOT NULL' },
      { name: 'user_id', type: 'varchar(64)', key: '', extra: 'NOT NULL' },
      { name: 'role', type: 'varchar(20)', key: '', extra: 'DEFAULT NULL' },
      { name: 'details', type: 'text', key: '', extra: 'NOT NULL' },
      { name: 'ip_mock', type: 'varchar(45)', key: '', extra: 'DEFAULT NULL' },
    ],
    count: 10,
  },
];
